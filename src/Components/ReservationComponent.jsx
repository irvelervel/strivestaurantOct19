...
class ReservationComponent extends React.Component {
  ...
  handleInput = ev => {
    ...
    this.setState({
      //replacing current reservation object with the new, modified version
  ...
  submitReservation = async () => {
    ...
    try {
      ...
      let response = await fetch(
        "https://strive-school-testing-apis.herokuapp.com/api/reservation",
        {
          method: "POST",
      ...
      if (response.ok) {
        ...
        this.setState({
          ...
          message: undefined,
          errorMessage:
            "Something went wrong in the creation of the reservation. Please try later or contact us @ +39 80 822 544"
        });
          ...
          <Row>
            ...
            <FormGroup className="col-md-6">
              ...
              <Input
                type="text"
                id="phone"
                placeholder="Insert here your phone"
